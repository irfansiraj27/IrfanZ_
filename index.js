...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=62895321033713:+62 895-3210-33713\n' // JANGAN KEK BABI SU
            + 'END:VCARD'
prefix = '.'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["62895321033713@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["62895321033713@s.whatsapp.net"]
			const frendsowner = ["62895321033713@s.whatsapp.net"]
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('0895-3210-33713@s.whatsapp.net', options, text, {quoted: mek})
